...
'@
	...
	info -Msg "This script will install joemob/nvimdots to:"
	...
	if ($USE_SSH) {
		clone_repo -WithURL 'git@github.com:joemob/nvimdots.git'
	} else {
		clone_repo -WithURL 'https://github.com/joemob/nvimdots.git'
	}
...
- Project Homepage:
    https://github.com/joemob/nvimdots
    ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
- Further documentation (including executables you |must| install for full functionality):
    https://github.com/joemob/nvimdots/wiki/Prerequisites
    ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
'@
